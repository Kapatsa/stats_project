...
Скорее всего данный аутлаер связан либо с ошибкой в данных, либо с умышленым завышением показателя ВВП страной, о чём немного позже.
...
```
Однако, при делении данных по фактору "нефть", сложно установить неоднородность данных. Можно предположить, что наличие/отсутсвие нефти не влияет на данные экономические показатели. 
...
Здесь сложно что-либо ожидать от 
