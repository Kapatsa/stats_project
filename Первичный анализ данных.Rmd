...
Получив то, что мы получили, можно предложить такое объяснение. Эффект более заметен на развивающихся странах, так как именно в это время многие из них стали вкладывать свои ресурсы в образование, а у развитых стран уровень образования в целом уже "сошёлся" к какому-то определённому высокому уровню.
...
Здесь предполагаемая зависимость похожа на влияние инвестиций на рост ВВП в случае стран ОЭСР: страны _уже_ развитые и рост может "сходиться" к нулю. Если же страна менее развита и/или находится в стадии формирования, то рост ВВП вряд ли будет зависеть от ВВП в "начале пути".
...
3) линейность, то есть точки на скатер плоте распределяются симетрично относительно регрессионой прямой.
...
Коэффициент Спирмана будет больше, если в данных наблюдается нелинейная монотоность. 


Посчитаем коэффициенты Пирсона и Спирмана на наших данных: 


**Влияние инвестиций на рост ВВП**
...
Предположим что на признак роста ВВП влияет так же уровень образованности:
